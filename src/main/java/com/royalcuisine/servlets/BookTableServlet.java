...
public class BookTableServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String tableNo = request.getParameter("table_id"); // Use table_no instead of packageSelected
        ...
        try {
            ...
            String sql = "INSERT INTO reservations (name, email, phone, reservation_date, reservation_time, guests, table_id) VALUES (?, ?, ?, ?, ?, ?, ?)";
            ...
            stmt.setString(7, tableNo); // Using table_no here
    ...
    private void sendConfirmationEmail(String toEmail, String name, String date, String time, String tableNo, String guests) {
